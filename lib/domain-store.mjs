...
const TABLE_COLUMNS = {
  ...
  // alongside wicked.verdict.recorded (see _emitEvent + domainEventToBusEvent).
  // When absent (most existing callers), only wicked.verdict.recorded fires.
  //
...
export class DomainStore {
  ...
  // wicked.verdict.recorded and wicked.evidence.captured).
