 ...
 *   - Event emission: no-op hook (_emitEvent) for v2 slot-in
...
export class DomainStore {
  ...
  // --- No-op event hook (v2 slot-in) ---
  _emitEvent(_action, _source, _id, _payload) {
    // Reserved for v2 event log integration
  }
