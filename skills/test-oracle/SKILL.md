...
```
The wicked-testing SQLite database is not available. Run /wicked-testing:setup to initialize the store, then run /wicked-testing:acceptance-testing or /wicked-testing:execution to populate it.
